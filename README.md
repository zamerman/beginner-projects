...
Ever played Mad [Libs](https://en.wikipedia.org/wiki/Mad_Libs)? If you haven't, here's the basic's of it.
...
- [Multiplication Table](https://github.com/alfredmuffin/Beginner-Projects/blob/master/Solutions/multable.py)
